...
- url: https://test.byeol23.shop (서비스 종료 예정, 미정)
## 개발 기간
- 2025.10.15-12.05(약 8주)
## 구성원
|                                                                 **김진수**                                                                  |                                                               **노형우**                                                               |                                   **박종현**                                    |                                                              **박지완**                                                              |                                                                 **임찬혁**                                                                 |                                                                 **장주호**                                                                  |                                                              **전규리**                                                              |                                                              **최유현**                                                              |
|:----------------------------------------------------------------------------------------------------------------------------------------:|:-----------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------:|
| [<img src="https://avatars.githubusercontent.com/u/100560249?v=4" height=100 width=100> <br/> @greenClothesZelda](https://github.com/greenClothesZelda) | [<img src="https://avatars.githubusercontent.com/u/69101572?v=4" height=100 width=100> <br/> @rhw2574](https://github.com/rhw2574) | [<img src="https://avatars.githubusercontent.com/u/52920187?v=4" height=100 width=100> <br/> @Hyeoninii](https://github.com/Hyeoninii) | [<img src="https://avatars.githubusercontent.com/u/90737984?v=4" height=100 width=100> <br/> @j1wan](https://github.com/j1wann) | [<img src="https://avatars.githubusercontent.com/u/144610436?v=4" height=100 width=100> <br/> @limch02](https://github.com/limch02) | [<img src="https://avatars.githubusercontent.com/u/180937125?v=4" height=100 width=100> <br/> @Waa-i](https://github.com/Waa-i) | [<img src="https://avatars.githubusercontent.com/u/86146265?v=4" height=100 width=100> <br/> @rlcz1](https://github.com/rlcz1) | [<img src="https://avatars.githubusercontent.com/u/166400487?s=400&u=be4746297eed12a7169d6769daf3b9c3003f1e28&v=4" height=100 width=100> <br/> @yuhyunchoi](https://github.com/yuhyunchoi) |
...
- 리뷰 작성 및 조회 
- 포인트 정책, 적립, 사용 등의 기능 구현
## 노형우
- 회원 탈퇴, 휴면 회원 관리
- 마이페이지 > 회원정보 수정
- 출판사 및 저자, 도서 태그 관리
## 박종현
- JWT 기반 인증 시스템, 일반로그인, 페이코 로그인
- 회원가입, 탈퇴, 휴면회원 처리, 회원 관리 기능 구현
## 박지완
- CI/CD 구축, SCG/Eureka 구성, 무중단 배포
- 각종 쿠폰(Welcome, 생일, 도서, 카테고리) 발급 및 적용 구현
## 임찬혁
- 관리자 도서관리, TUI Editor를 활용한 도서 등록
- 외부 API(알라딘)를 활용한 도서 데이터 등록
## 장주호
- ElasticSearch 구축, 복합 검색 및 정확도 향상 (Reranker), LLM 활용 검증, 검색 캐시 적용
- 카테고리 관리
- 회원/비회원 장바구니 구현
## 전규리
- 장바구니 구현
...
## 최유현
### 주문
1. 회원/비회원 주문(바로구매, 장바구니 구매)
2. 회원/비회원 주문 내역 조회, 상세 조회
3. 주문 시 배송일 지정, 포장지 설정 유무
4. 주소 API를 활용해 주소 지정
5. 회원 주문 시 회원 배송지 조회
6. 결제 금액 기준 배송비 정책 조회
7. 관리자 페이지 주문 번호, 주문자 이름, 주문 상태에 따른 필터링
8. 관리자 페이지 주문 상태 변경
9. 관리자 페이지 주문 내역 상세 조회
### 결제
1. Toss Payments Api를 활용한 결제 구현
2. Facade 패턴을 활용한 확장성을 고려한 설계
3. 회원/비회원 결제 취소
4. 결제 완료 시 재고 처리
### 도서
1. 도서 상세 페이지 구현
